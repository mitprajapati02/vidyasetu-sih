  ...
  if (!data) {
    return (
      <div className="flex items-center justify-center h-screen text-xl text-muted-foreground">
        ...
        <div className="animate-fade-up pl-4" style={{ animationDelay: "0.3s" }}>
          <Button
            size="lg"
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
        <div className="container mx-auto px-6 py-12">
          ...
          {/* Students Table */}
          <div className="overflow-auto rounded-lg border border-muted-foreground/10">
              ...
              <TableBody>
                {students.map((student, index) => (
                  ...
                  >
                    ...
                    <TableCell>{student.avg_attendance.toFixed(1)}%</TableCell>
                    <TableCell>{student.avg_marks.toFixed(1)}%</TableCell>
                    <TableCell>{student.fee_status}</TableCell>
                    <TableCell>
                      <Badge
                        className={`w-max rounded-md px-2 py-1 text-sm font-semibold ${
                          getRiskBadgeClass(student.risk_level)
                        }`}
                      >
                        {student.risk_level}
                      </Badge>
